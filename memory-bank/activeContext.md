...
- Added placeholder initialization scripts, VS Code tasks, and prompt files for future `web`, `python`, and `notebooks` modules
...
- Added placeholder initialization scripts, tasks, and prompts for `web`, `python`, and `notebooks` modules
